  ...
  return (
    <>
      <div className="flex items-center justify-center h-screen">
        {loginErrorBanner}
        <div className="p-8 mx-0 bg-white border-2 border-yellow-500 lg:w-1/3 rounded-lg  pb-2">
          ...
          <div className="flex justify-center items-center mt-8 flex-col">
            <button
              ...
              className="text-gray-100 border-grey-50 border hover:text-white shadow outline-none font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64"
            >
          ...
          <p className="flex justify-center mt-8 text-gray-400">
            Note : By sign in, you'll be redirected to the Google consent form
